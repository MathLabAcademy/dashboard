...
export const getAllClassPaymentReminderForMonth = (
  batchClassId,
  year,
  month
) => async dispatch => {
  ...
  dispatch({
    type: BATCHCLASSPAYMENT_REMINDER_SET_ALL,
    data,
    batchClassId,
    year,
    month
...
export const sendClassPaymentReminderForMonth = (
  batchClassId,
  year,
  month
) => async dispatch => {
  ...
  dispatch({
    type: BATCHCLASSPAYMENT_REMINDER_ADD,
    data,
    batchClassId,
    year,
    month
